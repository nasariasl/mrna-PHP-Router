...
<div class="w3-card-4">
  <img src="https://www.w3schools.com/w3css/img_recordplayer.jpg" alt="Disc" style="width:100%">
  <div class="w3-container w3-white">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    <p>Today</p>
...
<div class="w3-section w3-container">
<div class="w3-card-4">
  <img src="https://www.w3schools.com/w3css/img_snow.jpg" alt="Snow" style="width:100%">
  <div class="w3-container w3-white">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    <p>Today</p>
...
<div class="w3-card-4">
  <div class="w3-container w3-padding-16 w3-black w3-xxlarge">
    <p>&laquo;<i> Make it as simple as possible, but not simpler </i>&raquo;</p>
  </div>
  <div class="w3-container w3-white">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
    sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
